  ...
  personalInfo: {
    ...
    about: [
      ...
      },
      {
        ...
        text: "I'm proficient in using GIT commands for managing code versions and collaborating with others seamlessly."
      },
      {
  ...
  experience: [
    {
      ...
      location: "Gurugram",
      description: [
        "Develop, maintain, and optimize the mobile app by implementing new features, enhancing UI/UX, collaborating with teams, fixing bugs, integrating APIs, and ensuring scalability and security."
      ]
    },
    {
      ...
      location: "Gurugram",
      description: [
        "React Native Specialist with experience in Flutter and iOS development.",
        "Ownership of the project in a 9-member team, ensuring quality deliverables and tracking tasks through JIRA."
      ]
    },
    {
      company: "WebSoc Studio Software Technology pvt ltd",
      role: "Software Developer",
      duration: "Aug 2021 - May 2022",
      location: "Hydrabad",
      description: [
        "Custom applications and websites built using HTML, CSS, JavaScript, ReactJS, and React Native.",
        "Client-Focused Development: Ensured that the final products met the specific client requirements."
      ]
    }
  ],
  projects: [
    ...
    },
    {
      ...
      links: {
        ...
        appstore: "https://apps.apple.com/us/app/kym-know-your-medicine/id6747272676"
      }
    },
    {
    ...
    },
    {
      ...
      links: {
        ...
        playstore: "https://play.google.com/store/apps/details?id=com.alautun.shipperapp"
      }
    },
    {
  ...
  education: [
    {
      ...
      institute: "Amrutvaini College of Engineering",
      year: "May 2020"
    },
    {
      degree: "Diploma in Electronics and Tele-Communications",
      institute: "Amrutvahini College of Polytechnic",
      year: "May 2016"
    }
  ]
};
